...
the full list of sensor models registered at OceanOPS with their description.  Note that OceanOPS reference tables (sensor models, variables, agencies) use standard vocabularies when available. 
